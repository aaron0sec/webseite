...
export const metadata: Metadata = {
  ...
  description: "Ausgewählte Open Source Projekte von Joscha Aaron Schmidt zu OSINT, Webanalyse, Malware Analyse, Linux und Cybersecurity.",
  alternates: { canonical: "/projekte" },
};

const projects = [
  { name: "web-osint", description: "Werkzeuge für technische Webanalyse und strukturierte OSINT Recherche.", href: "https://github.com/linuxaaron/web-osint", icon: Search, tags: ["OSINT", "Web", "Analysis"] },
