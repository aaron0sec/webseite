...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Security Blog | Joscha Aaron Schmidt",
    description: "Technische Beiträge zu Linux, Cybersecurity, OSINT, Web Security, DFIR und Incident Response.",
