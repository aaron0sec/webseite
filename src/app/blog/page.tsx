...
const posts = [{ slug: "osint-webanalyse", title: "OSINT bei der technischen Webanalyse", date: "2026-08-08", category: "OSINT", excerpt: "Welche öffentlich zugänglichen Signale sich bei einer technischen Webanalyse sinnvoll kombinieren lassen." }];
