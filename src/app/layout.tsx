...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Joscha Aaron Schmidt — OSINT & Web Security", description: "OSINT, Web Security, Linux und technische Projekte.", type: "website", url: "https://digitalplat.org" },
