    ...
    <main>
                ...
                <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
                  <div>
                    <p className="font-mono text-xs tracking-[0.18em] text-[var(--accent)]">
                      {index === 1 ? "BELIEBT" : index === 2 ? "UMFANGREICH" : "LANDINGPAGE"}
                    </p>
                    ...
                    <ul className="mt-5 grid gap-3">
                      {pkg.scope.map((item) => (
                        <li key={item} className="flex gap-3 text-sm leading-6">
                          <Check className="mt-0.5 shrink-0 text-[var(--accent)]" size={18} />
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
      ...
      <section className="py-16 sm:py-20">
        <div className="container max-w-4xl">
          <div className="rounded-3xl border border-[var(--accent)]/40 bg-[var(--surface)] p-8 sm:p-10">
            <h2 className="text-2xl font-semibold sm:text-3xl">So läuft ein Projekt ab</h2>
