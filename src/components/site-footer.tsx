    ...
    <footer ref={footerRef} className="relative overflow-hidden border-t border-[var(--border)]">
      ...
      <div className="container relative z-20 py-10">
        ...
        <div className="grid gap-8 border-t border-[var(--border)] pt-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div><p className="font-semibold">Navigation</p><div className="mt-2 grid gap-2 text-sm text-[var(--muted)]"><a href="/">Startseite</a><a href="/blog">Blog</a><a href="/webentwicklung">Webentwicklung</a><a href="/buchung">Projekt anfragen</a></div></div>
          <div><p className="font-semibold">Rechtliches</p><div className="mt-2 grid gap-2 text-sm text-[var(--muted)]"><a href="/impressum">Impressum</a><a href="/datenschutz">Datenschutz</a><button onClick={openPrivacyNotice} className="text-left">Cookie-Einstellungen</button></div></div>
          <div><p className="font-semibold">Social</p><div className="mt-2 flex gap-3"><a aria-label="GitHub" href="https://github.com/linuxaaron" target="_blank" rel="noreferrer"><Github size={18}/></a><a aria-label="Instagram" href="https://instagram.com/linuxaaron" target="_blank" rel="noreferrer"><Instagram size={18}/></a><a aria-label="Music" href="/musik"><Music2 size={18}/></a></div></div>
        </div>
